...
class Crear_producto(QDialog):
    def __init__(self):
        ...
        btn_guardar_crear_producto = QPushButton("Guardar Producto")
        btn_guardar_crear_producto.clicked.connect(self.guardar_usuario)
        layout.addWidget(btn_guardar_crear_producto)
